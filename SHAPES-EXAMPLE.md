...
```
implementation 'com.github.approov:approov-service-volley:3.1.0'
```
...
Build and run the and press the `Get Shape` button. You should now see this (or another shape):
